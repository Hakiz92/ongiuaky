...
const Screen02 = ({ navigation, route }) => {
    ...
    return (
        <ScrollView stickyHeaderIndices={[1]} style={{ backgroundColor: 'yellow' }}>
            ...
            <View style={{
                ...
                <Image source={require("../assets/Data/banner.png")} style={{
                    width: '100%',
                    borderRadius: 10
                }} />
            </View>

            <View style={{ flexDirection: 'row', alignItems: 'end', justifyContent: 'space-between', marginHorizontal: '14px' }}>
